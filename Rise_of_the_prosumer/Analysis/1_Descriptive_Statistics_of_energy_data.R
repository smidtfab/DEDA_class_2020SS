...
functions = c("FUN_getTargets.R") #from https://github.com/QuantLet/BLEM/tree/master/BLEMevaluateMarketSim
...
ggsave("output/actual/graphs/producers_all.png", height = 8.267, width = 11.692, bg="transparent")
...
plot_grid(plotlist = plotgrids, nrow = 4, ncol = 3)
ggsave("output/actual/graphs/consumers_all.png", height = 8.267, width = 11.692, bg="transparent")
...
for(i in 1: length(datasets_cp)) {
 ...
 plotgrids[[i]] = 
   ...
   # ggsave("net_prod_"%&%i%&%".png", height = 8.267, width = 11.692, bg="transparent")
  i=i+1
}

plot_grid(plotlist = plotgrids, nrow = 4, ncol = 3)
ggsave("output/actual/graphs/net_prod_all.png", height = 16.534, width = 23.384, bg="transparent")
