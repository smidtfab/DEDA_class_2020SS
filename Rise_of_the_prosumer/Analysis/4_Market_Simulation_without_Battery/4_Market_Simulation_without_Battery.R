...
ggsave("../output/actual/graphs/nobattery_smoothed_self-consumption_rate_2.png", height = 16.534, width = 23.384, bg="transparent")
...
plot_grid(plotlist = plotgrids, nrow = 4, ncol = 2)
ggsave("../output/actual/graphs/nobattery_smoothed_self-sufficiency_rate_2.png", height = 16.534, width = 23.384, bg="transparent")
...
ggsave("../output/actual/graphs/P2P_cons_nobat.png", height = 16.534, width = 23.384, bg="transparent")
...
ggsave("../output/actual/graphs/P2P_energy_sharing_nobat_July7.png", height = 16.534, width = 23.384, bg="transparent")
