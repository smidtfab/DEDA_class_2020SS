...
#setwd("~/Documents/DEDA/Rise_of_the_prosumer/Analysis") #adjust working directory accordingly to be in "Analysis" folder
...
plot_grid(plotlist = plotgrids, nrow = 1, ncol = 1)
ggsave("output/actual/graphs/P2G_prod.png", height = 16.534, width = 23.384, bg="transparent")


#Energy Bill with P2P trading -> use Prcing Mechanism (P2P)
...
plot_grid(plotlist = plotgrids, nrow = 1, ncol = 1)
ggsave("output/actual/graphs/P2P_cons_bat.png", height = 16.534, width = 23.384, bg="transparent")
...
ggsave("output/actual/graphs/price_log2.png", height = 16.534, width = 23.384, bg="transparent")
