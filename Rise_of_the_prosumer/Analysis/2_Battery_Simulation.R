...
# Simulate Battery for different sizes
...
# aggregate prosumer consumpion (column 2), 
...
summary(netload) #to determine plausible battery size -> let's try different battery sizes of 100, 200, 500, 1000, 2000, 5000, 10000 kWh


# Battery  simulation with 7 different sizes

#------potentially include self discharging, charging and discharging rates as well!!!!!!!
...
ggsave("output/actual/graphs/battery_SOC_smooth_2.png", height = 16.534, width = 23.384, bg="transparent")
